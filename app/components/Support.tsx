  ...
  return (
    <div className="flex justify-center items-center p-4">
      <div className="flex flex-wrap justify-center gap-8 p-8 w-full max-w-6xl">
        ...
        <div className="flex flex-col items-start w-full sm:w-[300px] bg-white p-6 rounded-lg hover:scale-105 transform transition-all duration-300">
          <Image src={dollar} alt="Best Prices" className="w-10 h-10 mb-4" />
          <h1 className="text-2xl font-semibold text-gray-800 mb-2">
            Best Prices
          </h1>
          <p className="text-base font-medium text-gray-600">
            Shop with confidence and get the best prices on top-quality products.
          </p>
        </div>
        <div className="flex flex-col items-start w-full sm:w-[300px] bg-white p-6 rounded-lg hover:scale-105 transform transition-all duration-300">
          <Image
        ...
        <div className="flex flex-col items-start w-full sm:w-[300px] bg-white p-6 rounded-lg hover:scale-105 transform transition-all duration-300">
          ...
          <p className="text-base font-medium text-gray-600">
            We offer secure and trusted payment methods for all transactions.
          </p>
        </div>
      </div>
    </div>
